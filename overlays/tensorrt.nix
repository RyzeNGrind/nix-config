...
final: prev: {
  tensorrt = rec {
    ...
    tensorrt_10_8_cuda11 = final.callPackage ../pkgs/tensorrt/generic.nix {
    ...
    tensorrt_10_8_cuda12 = final.callPackage ../pkgs/tensorrt/generic.nix {
      inherit (prev.cudaPackages) cudatoolkit;
      version = "10.8.0.43";
      cudaVersion = "12.8";
      arch = "x86_64-gnu";
    ...
    tensorrt_10_8_cuda12_aarch64 = final.callPackage ../pkgs/tensorrt/generic.nix {
      inherit (prev.cudaPackages) cudatoolkit;
      version = "10.8.0.43";
      cudaVersion = "12.8";
      arch = "aarch64-gnu";
    ...
    tensorrt_8_6_cuda11 = final.callPackage ../pkgs/tensorrt/generic.nix {
      inherit (prev.cudaPackages) cudatoolkit;
      version = "8.6.1.6";
      cudaVersion = "11.8";
      arch = "x86_64-gnu";
    ...
    tensorrt_8_6_cuda12 = final.callPackage ../pkgs/tensorrt/generic.nix {
      inherit (prev.cudaPackages) cudatoolkit;
      version = "8.6.1.6";
      cudaVersion = "12.0";
      arch = "x86_64-gnu";
    ...
    tensorrt_8_6_cuda12_aarch64 = final.callPackage ../pkgs/tensorrt/generic.nix {
      inherit (prev.cudaPackages) cudatoolkit;
      version = "8.6.1.6";
      cudaVersion = "12.0";
      arch = "aarch64-gnu";
